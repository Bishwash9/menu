...
const Icons = {
  ...
  Bookings: <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="18" height="18" x="3" y="4" rx="2" ry="2"/><line x1="16" x2="16" y1="2" y2="6"/><line x1="8" x2="8" y1="2" y2="6"/><line x1="3" x2="21" y1="10" y2="10"/></svg>,
  Rooms: <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 9.5L12 4l9 5.5V19a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V9.5z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>,
...
export const SIDEBAR_CONFIG: Record<Role, SidebarItem[]> = {
  ...
  user: [
    ...
    { label: 'Profile', icon: Icons.Guests },
    { label: 'Settings', icon: Icons.Settings },
  ],
  staff: [
    { label: 'Dashboard', icon: Icons.Dashboard },
    { label: 'Kitchen', icon: Icons.Cafe },
    { label: 'Guests', icon: Icons.Guests },
    { label: 'Settings', icon: Icons.Settings },
  ]
};