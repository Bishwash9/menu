...
export default function DashboardHeader({ initials = "DA" }) {
        ...
        <div className="relative" ref={notificationsRef}>
          <button 
            ...
            className={`p-2 rounded-lg transition-colors relative ${
              isNotificationsOpen ? "bg-slate-100 text-slate-900" : "text-slate-500 hover:bg-slate-50 hover:text-slate-700"
            }`}
          >
            <Bell size={19} />
